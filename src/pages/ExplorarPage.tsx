  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-soft border border-white/80 min-h-[400px] sm:min-h-[400px] flex items-center p-5 sm:p-8">
        <img
          src="/assets/img1.png"
          alt="Explorar productos locales Liwa"
        ...
        <div className="relative z-10 max-w-xl text-white space-y-1.5 sm:space-y-2">
          <span className="inline-block text-[10px] sm:text-xs font-black uppercase tracking-wider px-2.5 py-0.5 sm:py-1 rounded-full bg-[#EC006C] text-white shadow-xs">
            Comercio Local
          </span>
          <h2 className="text-lg sm:text-2xl font-black text-white leading-tight">
            De la tierra y el taller a tus manos
          </h2>
          <p className="text-xs sm:text-sm text-slate-100 font-normal leading-relaxed">
            Descubre productos auténticos, cosechas frescas y creaciones únicas de productores y emprendedores de toda Nicaragua.
          </p>
        </div>
      </div>
